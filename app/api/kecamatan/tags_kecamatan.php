...
$qstring = "SELECT kl.id_kelurahan, kl.nama_kelurahan, k.nama_kecamatan, kk.nama_kabupaten_kota, p.nama_provinsi FROM kelurahan kl";
...
$qstring .= " kk.nama_kabupaten_kota LIKE '" . $term . "%' or";
$qstring .= " p.nama_provinsi LIKE '" . $term . "%'";
// echo $qstring; exit();
